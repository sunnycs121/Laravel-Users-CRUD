            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    @if (!$response['error'])
                        ...
                        <div>Date Created: {{ date('m/d/Y h:i A', strtotime($response['data']->dateCreated)) }}</div>
                        <!-- <div><button type="button" class="btn-close" data-bs-dismiss="modal">Close</button></div> -->
                    @else
